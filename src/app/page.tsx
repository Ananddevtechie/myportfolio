...
export const metadata: Metadata = {
  title: "Anand | Frontend Web Developer Portfolio",
  description: "I am a UI Developer with 4+ years of experience in building responsive, scalable, and user-friendly web applications. I specialize in Angular, React, JavaScript, and TypeScript, with hands-on expertise in developing modern front-end solutions for enterprise and smart city projects. My experience spans working with IoT & Smart City platforms, integrating APIs & web services, and delivering responsive designs using HTML5, CSS3, Material UI, and media queries.",
    keywords: [
  ...
  twitter: {
    ...
    title: "Anand | Frontend Web Developer Portfolio",
    description:
      "I am a UI Developer with 4+ years of experience in building responsive, scalable, and user-friendly web applications. I specialize in Angular, React, JavaScript, and TypeScript, with hands-on expertise in developing modern front-end solutions for enterprise and smart city projects. My experience spans working with IoT & Smart City platforms, integrating APIs & web services, and delivering responsive designs using HTML5, CSS3, Material UI, and media queries.",
  },
  ...
  return (
    <main className="flex-none h-auto px-4 md:px-8 lg:px-28 relative w-[100%] m-auto">
      ...
      <section className="py-28 relative overflow-hidden">
        ...
        <div className="absolute top-60 right-10 w-32 h-32 bg-purple-100 rounded-full opacity-20 animate-pulse"></div>
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="text-center lg:text-left lg:w-1/2 space-y-8">
              {/* Greeting with Animation */}
                      <div className="absolute bottom-15 left-10 w-24 h-24 bg-purple-200 rounded-full opacity-30 animate-pulse delay-3000"></div>
              ...
              <div className="space-y-6">
                <p className="text-gray-700 text-lg lg:text-xl xl:text-2xl leading-relaxed max-w-2xl animate-fade-in-up delay-500">
                  ...
                  I create responsive platforms and intelligent interfaces tailored for{" "}
                  ...
                  <span className="text-purple-600 font-semibold">
                   ...
                   I deliver scalable, high-performance web solutions that enhance user engagement and drive digital transformation.
                </p>
                ...
                <div className="flex flex-wrap gap-4 justify-center lg:justify-start animate-fade-in-up delay-600">
                  ...
                  <span className="bg-purple-50 text-purple-700 px-4 py-2 rounded-full text-sm font-medium border border-purple-200">
                    Typescript & JavaScript profiency
                  </span>
                  <span className="bg-purple-50 text-purple-700 px-4 py-2 rounded-full text-sm font-medium border border-purple-200">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-6 animate-fade-in-up delay-700">
                ...
                <Link
                  href="https://Anandnakum-portfolio.vercel.app/AnandResume.pdf"
                  target="_blank"
