...
export const metadata: Metadata = {
  title: "Projects | Anand - Frontend Developer",
  description:
    "Explore projects developed by Anand, a frontend web developer specializing in React, Next.js, TypeScript, and modern web technologies.",
  keywords: [
